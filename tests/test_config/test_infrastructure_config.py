...
@pytest.mark.unit
def test_infrastructure_manager_creation() -> None:
...
@pytest.mark.unit
def test_infrastructure_manager_is_singleton_like() -> None:
...
def test_prepare_environment_creates_lock(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_release_resources_removes_lock(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_prepare_environment_with_existing_lock(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_release_resources_idempotent(tmp_path: Path) -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_no_error() -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_callable() -> None:
...
@pytest.mark.integration
def test_integration_with_hardware_config(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_prepare_environment_with_logger(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_release_resources_with_logger(tmp_path: Path) -> None:
...
@pytest.mark.unit
def test_infrastructure_manager_frozen() -> None:
...
@pytest.mark.unit
def test_infrastructure_manager_rejects_extra_fields() -> None:
...
@pytest.mark.integration
def test_optuna_hardware_integration() -> None:
...
@pytest.mark.integration
def test_prepare_environment_with_process_kill_enabled(
...
@pytest.mark.integration
def test_prepare_environment_skips_process_kill_on_shared_env(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_with_pbs_environment(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_with_cuda(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_with_mps(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.unit
def test_release_resources_lock_failure(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_prepare_environment_detects_lsb_jobid(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_detects_rank_env(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_detects_local_rank_env(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_calls_ensure_single_instance_with_correct_kwargs(
    tmp_path: Path,
) -> None:
...
@pytest.mark.integration
def test_release_resources_calls_release_single_instance_with_lock_path(tmp_path: Path) -> None:
...
@pytest.mark.unit
def test_release_resources_calls_flush_compute_cache(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_prepare_environment_default_logger_fallback(tmp_path: Path) -> None:
...
@pytest.mark.unit
def test_release_resources_default_logger_fallback(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_default_logger_fallback(monkeypatch: pytest.MonkeyPatch) -> None:
...
@pytest.mark.integration
def test_prepare_environment_process_kill_calls_terminate_duplicates(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_any_shared_env_skips_kill(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_prepare_environment_lock_acquired_message(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_release_resources_info_level_for_lock_released(tmp_path: Path) -> None:
...
@pytest.mark.unit
def test_release_resources_error_level_for_lock_failure(tmp_path: Path) -> None:
...
@pytest.mark.integration
def test_prepare_environment_terminate_duplicates_receives_logger(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.integration
def test_prepare_environment_num_zombies_in_message(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
...
@pytest.mark.unit
def test_flush_compute_cache_no_cuda_no_mps_no_log(monkeypatch: pytest.MonkeyPatch) -> None:
