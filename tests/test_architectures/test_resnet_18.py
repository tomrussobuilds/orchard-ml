...
class TestResNet18Low:
    ...
    def test_pretrained_weight_morphing_28(self, device: torch.device) -> None:
        ...
        with patch.object(resnet_module, "models") as mock_models:
            ...
            _ = build_resnet_18(num_classes=5, in_channels=1, pretrained=True, resolution=28)
...
class TestResNet18High:
    ...
    def test_pretrained_weight_morphing_224(self, device: torch.device) -> None:
        ...
        with patch.object(resnet_module, "models") as mock_models:
            ...
            _ = build_resnet_18(num_classes=5, in_channels=1, pretrained=True, resolution=224)
