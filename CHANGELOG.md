...
- replay bootstrap warnings into the run log
...
- raise gitpython floor to 3.1.58 and document cryptography cap
...
- bump mako and gitpython constraints to clear 4 high-severity Dependabot alerts
...
- bump git-cliff to v4.7.1, add Docker build CI
...
- pre-release audit — detection logging, grayscale fix, naming cleanup
