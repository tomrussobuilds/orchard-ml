...
Mutation testing documentation has been moved to a dedicated guide.
See **[Mutation Testing (MUTANTS.md)](MUTANTS.md)** for configuration,
running mutmut, the mutation registry, pragma conventions, and more.
